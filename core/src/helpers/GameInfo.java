...
public class GameInfo {
    ...
    public static final float HEIGHT_OF_PICTURE_CARD = 120;
    public static final float WIDTH_OF_PICTURE_CARD = 195;

    public static final float HIGH_OF_SYLLABLE_CARD = 130;
    ...
    public static final float STEP_FOR_TETRIS_Y = GameInfo.HEIGHT_OF_PICTURE_CARD;
    public static final float SLOW_STEP_FOR_TETRIS_X = 1f;
